...
@SuppressLint("NewApi")
open class NotificationsItemAdapter: RecyclerView.Adapter<NotificationsItemAdapter.RequestsViewHolder>() {

    private val diffCallback = object : DiffUtil.ItemCallback<MyTicketsResponseItem>() {
        override fun areItemsTheSame(
            oldItem: MyTicketsResponseItem,
            newItem: MyTicketsResponseItem
        ): Boolean {
    ...
    fun submitList(list: List<MyTicketsResponseItem>) {
